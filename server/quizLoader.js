...
// Default Demo Sheet (You can replace this with your own published CSV link)
// You can set this via the GOOGLE_SHEET_URL environment variable.
const DEFAULT_SHEET_URL = process.env.GOOGLE_SHEET_URL || 'https://docs.google.com/spreadsheets/d/e/2PACX-1vR_example_sheet_id/pub?output=csv';
